          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {categoriesWithCounts.map((category: any) => {
              ...
              return (
                ...
                >
                  <Card className="bg-white rounded-xl overflow-hidden shadow hover:shadow-lg motion-safe:hover:scale-[1.02] motion-safe:transform transition-all duration-300 cursor-pointer border border-slate-100">
                    <div className="bg-gradient-to-br from-teal-600 to-blue-900 p-8 text-white">
